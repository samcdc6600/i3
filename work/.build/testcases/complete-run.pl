...
use lib qw(/usr/ports/x11-wm/i3/work/.build/testcases/lib /usr/ports/x11-wm/i3/work/i3-4.17/../i3-4.17/testcases/lib /usr/ports/x11-wm/i3/work/i3-4.17/../i3-4.17/AnyEvent-I3/blib/lib);
...
my @binaries = qw(
                   /usr/ports/x11-wm/i3/work/.build/i3
                   /usr/ports/x11-wm/i3/work/.build/i3bar/i3bar
                   /usr/ports/x11-wm/i3/work/.build/i3-config-wizard/i3-config-wizard
                   /usr/ports/x11-wm/i3/work/.build/i3-dump-log/i3-dump-log
                   /usr/ports/x11-wm/i3/work/.build/i3-input/i3-input
                   /usr/ports/x11-wm/i3/work/.build/i3-msg/i3-msg
                   /usr/ports/x11-wm/i3/work/.build/i3-nagbar/i3-nagbar
               );
...
my @test_binaries = qw(
                        /usr/ports/x11-wm/i3/work/.build/test.commands_parser
                        /usr/ports/x11-wm/i3/work/.build/test.config_parser
                        /usr/ports/x11-wm/i3/work/.build/test.inject_randr15
                    );
...
$ENV{PATH} = join(':',
    '/usr/ports/x11-wm/i3/work/.build/i3-nagbar',
    '/usr/ports/x11-wm/i3/work/.build/i3-msg',
    '/usr/ports/x11-wm/i3/work/.build/i3-input',
    '/usr/ports/x11-wm/i3/work/.build/i3-dump-log',
    '/usr/ports/x11-wm/i3/work/.build/i3-config-wizard',
    '/usr/ports/x11-wm/i3/work/.build/i3bar',
    '/usr/ports/x11-wm/i3/work/.build',
    '/usr/ports/x11-wm/i3/work/i3-4.17/../i3-4.17',
    $ENV{PATH});
...
if (scalar @testfiles == 0) {
    @testfiles = </usr/ports/x11-wm/i3/work/i3-4.17/../i3-4.17/testcases/t/*.t> if @testfiles == 0;
} else {
    @testfiles = map {
        # Fully qualify each specified file if necessary
        if (! -e $_) {
            $_ = "/usr/ports/x11-wm/i3/work/i3-4.17/../i3-4.17/testcases/$_";
        }
        $_
    } @testfiles;
}
