...
use X11::XCB::Window;
use X11::XCB qw(:all);
use lib qw(/usr/ports/x11-wm/i3/work/i3-4.17/../i3-4.17/AnyEvent-I3/blib/lib);
use AnyEvent::I3;
...
sub launch_with_config {
    ...
    if ($config ne '-default') {
        ...
        open(my $conf_fh, '<', '/usr/ports/x11-wm/i3/work/i3-4.17/../i3-4.17/testcases/i3-test.config')
